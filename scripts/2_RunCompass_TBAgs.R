...
gsPath <- file.path(projectDir, "out/GatingSets/AllBatchesForCompass_TBAgs")
seed <- 20180731
...
outdir <- file.path(projectDir, "out/CompassOutput/TBAgs/CD4")
node <- "4+"
...
outdir <- file.path(projectDir, "out/CompassOutput/TBAgs/CD8")
node <- "8+"
...
outdir <- file.path(projectDir, "out/CompassOutput/TBAgs/DN")
node <- "DNeg"
...
outdir <- file.path(projectDir, "out/CompassOutput/TBAgs/DP")
node <- "DPos"
